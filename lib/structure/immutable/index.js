...
var _mergeDeep = _interopRequireDefault(require("../plain/mergeDeep"));
...
var structure = {
  ...
  mergeDeep: function mergeDeep(target) {
    ...
    return _immutable.Iterable.isIterable(target) ? target.mergeDeep(sources[0]) : (0, _mergeDeep["default"])(target, sources);
  },
